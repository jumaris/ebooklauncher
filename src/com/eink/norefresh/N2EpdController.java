...
public class N2EpdController {
    ...
    public static void enterA2Mode() {
        ...
        System.err.println(N2EpdController.vCurrentNode);
        try {
            ...
            Object localRegionParams = RegionParamsConstructor.newInstance(new Object[] { 0,
                    0,
                    600,
                    800,
                    waveEnums[2],
            ...
            epdControllerSetRegionMethod.invoke(null, new Object[] { "NoRefreshToggle",
                    regionEnums[2],
                    localRegionParams });
            N2EpdController.vCurrentNode = 3;
    ...
    /*
     * W/System.err( 6883): GC W/System.err( 6883): GU W/System.err( 6883): DU W/System.err( 6883):
     * A2 W/System.err( 6883): GL16 W/System.err( 6883): AUTO
     * 
     * W/System.err( 6982): APP_1 W/System.err( 6982): APP_2 W/System.err( 6982): APP_3
     * W/System.err( 6982): APP_4
     */
    public static void exitA2Mode() {
        System.err.println("NoRefreshToggle::exitA2Mode");
        N2EpdController.vCurrentNode = 0;
        try {
            Class epdControllerClass = Class.forName("android.hardware.EpdController");
            Class epdControllerRegionClass = Class.forName("android.hardware.EpdController$Region");
            Class epdControllerRegionParamsClass = Class.forName("android.hardware.EpdController$RegionParams");
    ...
    public static void setDUMode() {
        ...
        try {
            ...
            epdControllerSetRegionMethod.invoke(null, new Object[] { "NoRefreshToggle",
                    regionEnums[2],
                    localRegionParams });
            N2EpdController.vCurrentNode = 2;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void setGL16Mode(int reset) {
        ...
        try {
            ...
            // System.err.println("get " + String.valueOf(reset) + " " +
            // String.valueOf(vCurrentNode));

            if ((reset > 0) || (N2EpdController.vCurrentNode < 0)) {
                ...
                epdControllerSetRegionMethod.invoke(null, new Object[] { "NoRefreshToggle",
                        ...
                        modeEnums[6] });
                if (reset > 0) {
                    N2EpdController.vCurrentNode = 1 - reset;
                } else {
                    N2EpdController.vCurrentNode++;
                }
            } else {
                if ((N2EpdController.vCurrentNode == 0) || (N2EpdController.GL16_MODE == 1)
                        || (N2EpdController.GL16_MODE == 2)) {
                    // System.err.println("EpdController setting.");
                    if (N2EpdController.vCurrentNode == 0) {
                        epdControllerSetRegionMethod.invoke(null, new Object[] { "NoRefreshToggle",
                                regionEnums[2],
                                localRegionParams,
                                modeEnums[N2EpdController.GL16_MODE] });
                    }
                    if (N2EpdController.vCurrentNode == 0) {
                        N2EpdController.vCurrentNode++;
                    }
