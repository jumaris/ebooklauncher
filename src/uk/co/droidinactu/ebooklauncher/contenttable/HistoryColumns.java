...
public abstract interface HistoryColumns extends BaseColumns {
    public static final String ADDED_COUNTER = "added_counter";
    ...
    public static final String TYPE_ADDED_COUNTER = "INTEGER";
