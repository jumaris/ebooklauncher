...
public class EInkListView extends ListView {
	/**
	 * My experiments show that update mode 
	 * 5 is b/w and fast (and I guess not as easy to get out of as the other ones?)
	 * 4 is flashy,   
	 * 2 or 3 may be suitable for "normal" use.
	 * 1
	 * 0 leaves rubbish behind, then clears screen
	 */
	public static int mUpdateMode = 2;

	public EInkListView(final Context context) {
		super(context);
	}

	public EInkListView(final Context context, final AttributeSet attrs) {
		super(context, attrs);
	}

	public EInkListView(final Context context, final AttributeSet attrs, final int defStyle) {
