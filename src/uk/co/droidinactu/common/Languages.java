...
public final class Languages {
    ...
    static enum Language {
        ...
        // ITALIAN("it", "Italian", R.drawable.it), JAPANESE("ja", "Japanese", R.drawable.jp),
        ...
        public static Language findLanguageByShortName(String shortName) {
            return Language.mShortNameToLanguage.get(shortName);
        }
        ...
        private int mFlag;
        private static Map<String, String> mLongNameToShortName = new HashMap<String, String>();
        private static Map<String, Language> mShortNameToLanguage = new HashMap<String, Languages.Language>();

        static {
            for (Language language : Language.values()) {
                Language.mLongNameToShortName.put(language.getLongName(), language.getShortName());
                Language.mShortNameToLanguage.put(language.getShortName(), language);
            }
        }

        private Language(String shortName, String longName) {
            this.init(shortName, longName, -1);
        }

        private Language(String shortName, String longName, int flag) {
            this.init(shortName, longName, flag);
        }

        public void configureButton(Activity activity, Button button) {
            button.setTag(this);
            button.setText(this.getLongName());
            int f = this.getFlag();
            if (f != -1) {
    ...
    public static String LOG_TAG = "Languages:";
    ...
    private static void log(String s) {
        Log.d(EBookLauncherApplication.LOG_TAG, Languages.LOG_TAG + "[Languages] " + s);
    }
