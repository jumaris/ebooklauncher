...
public final class AboutIntents {
	...
	/**
	 * Activity Action: Show an about dialog to display information about the
	 * application.
	 * 
	 * The application information is retrieved from the application's manifest.
	 * In order to send the package you have to launch this activity through
	 * startActivityForResult().
	 * 
	 * Alternatively, you can specify the package name manually through the extra
	 * EXTRA_PACKAGE.
	 * 
	 ...
	 * 
	 * If you start the About dialog through startActivityForResult() then the
	 * application package is sent automatically and does not need to be supplied
	 * here.
	 * 
	 * <p>
	 ...
	 * 
	 * Specify the name of the image resource as a String. Use the result from
	 ...
	 * 
	 * This string is displayed in a label in the main dialog, thus it should be a
	 * short explanation of the main purpose of the program, not a detailed list
	 * of features.
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_COMMENTS name.
	 * 
	 * <p>
	 ...
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_COPYRIGHT name.
	 * 
	 * <p>
	 ...
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_WEBSITE_URL name.
	 * 
	 * <p>
	 ...
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_WEBSITE_LABEL name.
	 * 
	...
	/**
	 * Optional intent extra: The authors of the program, as an array of strings.
	 * 
	 * Each string may contain email addresses and URLs, which will be displayed
	 * as links.
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_AUTHORS name.
	 * 
	 * <p>
	...
	/**
	 * Optional intent extra: The people documenting the program, as an array of
	 * strings.
	 * 
	 * Each string may contain email addresses and URLs, which will be displayed
	 * as links.
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_DOCUMENTERS name.
	 * 
	 * <p>
	...
	/**
	 * Optional intent extra: The people who made the translation for the current
	 * localization, as an array of strings.
	 * 
	 * Each string may contain email addresses and URLs, which will be displayed
	 * as links. Only list those for the currently used/shown L10n.
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_TRANSLATORS name.
	 * 
	 * <p>
	...
	/**
	 * Optional intent extra: The people who contributed artwork to the program,
	 ...
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_ARTISTS name.
	 * 
	 * <p>
	...
	/**
	 * Optional intent extra: The name of the raw resource containing the license
	 * of the program.
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_LICENSE name.
	 * 
	 * <p>
	...
	/**
	 * Optional intent extra: The primary email address for this application.
	 * 
	 * By default, this is retrieved from the Manifest meta tag with the
	 * AboutMetaData.METADATA_EMAIL name.
	 * 
	 * <p>
